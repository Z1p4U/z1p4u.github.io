    ...
    <div className="relative z-10 pt-32 pb-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          <div className="group relative overflow-hidden p-4 rounded-xl border border-border/50 bg-secondary/30 transition-all duration-300 hover:border-primary/30 hover:bg-secondary/45 hover:shadow-[0_18px_45px_rgba(124,58,237,0.12)]">
