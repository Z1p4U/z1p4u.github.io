...
export const seedProfile: PortfolioProfile = {
  name: "Thant Zin Htet",
...
export const seedServices: PortfolioService[] = [
  {
...
export const seedSkills: PortfolioSkill[] = [
...
export const seedExperiences: PortfolioExperience[] = [
  {
...
export function makeSeedDetailSections(
